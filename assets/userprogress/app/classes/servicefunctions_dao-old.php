...
class servicefunctions_dao {
    ...
    function getChildUserProgress($childid) {
        ...
        ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND (id_game like 'GMPAR%' AND id_child = '$childid') AS PGMM,";
        ...
        //         // -- ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NOLM%' AND id_child = '$childid') AS PNOLM,";
                ...
                ( SELECT SUM(time2answer) FROM `game_play_detail_tbl` WHERE id_child = '$childid' AND id_question like 'NS%') AS PMNST,
                ( SELECT SUM(time2answer) FROM `chm_game_play_detail_tbl` WHERE id_child = '$childid' AND id_question like 'NS%' ) AS CMNSST,
                ( SELECT SUM(time2answer) FROM `game_play_detail_tbl` WHERE id_child = '$childid' AND id_question like 'G%') AS PMGMT,
