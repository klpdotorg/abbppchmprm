<?php
  ...
  class prmreports_dao {
	...
	function getMyReports($user_id) {
	   ...
	   $arrResult = $this->dbh->readRecordsAllFields('myreports_prm_tbl',$condition);
	...
	function getAllReports(){
	    ...
	    $query="select rt.*,rgt.group_name from reports_prm_tbl rt left join reports_prm_groups_tbl rgt
	...
	function getAllColumnsByReportId($report_id){
	    ...
	    $arrResult = $this->dbh->readRecordsAllFields('report_prm_columns_tbl',$condition);
	...
	function getAllwhereclauseByReportId($report_id){
	    ...
	    $arrResult = $this->dbh->readRecordsAllFields('report_prm_whereclause_tbl',$condition);
	...
	function getReportByReportId($report_id){
	    ...
	    $arrResult = $this->dbh->readRecordsAllFields('reports_prm_tbl',$condition);
	...
	function getMyColumnsByReportId($myreport_id){
	      ...
	      $query ="select rct.report_column_auto_id,
			    ...
			    from report_prm_columns_tbl as rct,
			         myreport_prm_columns_tbl as mct,
				 myreports_prm_tbl as mt
				where
	...
	function getMywhereclauseByReportId($myreport_id){
	    ...
	    $query =" select myreport_whereclause_id,
			    ...
			    from myreport_prm_whereclause_tbl as rwt
				where
	...
	function getAllMasterRecords(){
	    ...
	    $arrResult = $this->dbh->readRecordsAllFields('report_prm_master_wc_tbl');
