...
?>
                              <form action="<?php echo $_SESSION['EMRP_BASE_URL'].$cfg_prmreportscontroller.'?taskname=show_report_view_datatable_custom&report_id='.$allReports['report_id'];?>>", method="post" name="columnsselectform" id="columnsselectform">
