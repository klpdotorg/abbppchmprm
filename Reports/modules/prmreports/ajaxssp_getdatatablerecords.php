...
$arrSelectedColumns = $_SESSION['emrp_selectedcolumns'];

$table = $_SESSION['emrp_db_report_view_name'];
// Table's primary key

$primaryKey =  $_SESSION['emrp_uniquevaluecolumnname'];
$whereAll = $_SESSION['emrp_wherequery'];
...
$output = SSP::complex ( $_REQUEST, $sql_details, $table, $primaryKey, $columns, $whereResult=null, $whereAll);
