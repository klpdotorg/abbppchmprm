    ...
    switch($taskname) {
        ...
        case 'show_report_view_datatable_default':
            ...
            */
            ...
            $args['view_name'] = "chmshow_report_view_datatable";
            ...
            $_SESSION['chm_emrp_selectedcolumns'] = $selectedcolumns;
            $_SESSION['chm_emrp_db_report_view_name'] = $report[0]['view_name'];
            $_SESSION['chm_emrp_uniquevaluecolumnname'] = $report[0]['uniquevaluecolumnname'];
            $_SESSION['chm_emrp_wherequery'] = $whereClause;
        ...
        case 'show_report_view_datatable_custom':
            ...
            */
            ...
            $_SESSION['chm_emrp_wherequery'] = $whereQuery;
