...
/**
 * Service API:  txabbprmgameplay
 * Purpose: Sync the Practice Mode 'gameplay' data to the ABB Backend Server 
 * File name: txabbprmgameplay.php
 ...
 */
    ...
    if(count($jsondata_array,1) == 0) {
        ...
        $em = new exceptionMgr(" ");
        $em->logInfo("txabbprmgameplay: Error: Received no input JSON data."); 
    }
    else {
        ...
        foreach($jsondata_array as $data) {
            ...
            if($data) {
                ...
                if(!$childexists) {
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txabbprmgameplay: Error: No account exists with the given name and deviceid (".$avatarname.",".$deviceid.")");
                }
                else {
                    ...
                    if($childid == null) {
                        ...
                        $em = new exceptionMgr(" ");
                        $em->logInfo("txabbprmgameplay: Error: Could not retrive the Child ID for the given name and deviceid (".$avatarname.",".$deviceid.")");
                    }
                    else {
                        ...
                        if($rtn) {
                            ...
                            $em = new exceptionMgr(" ");
                            $em->logInfo("txabbprmgameplay: Error: Failed to save Gameplay Data."); 
                        }
                    }
                }
            }
                ...
                $em = new exceptionMgr(" ");
                $em->logInfo("txabbprmgameplay: Error: Data missing for this JSON object."); 
             }
